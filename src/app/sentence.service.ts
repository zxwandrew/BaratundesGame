    ...
    async getSentencesAsync() {
        return await fetch("https://api.airtable.com/v0/appV76ut1BlB8UCJO/Incident%20Headlines?api_key=" + this.apiKey)
            ...
            .then(incidents => {
                ...
                return Promise.all(allrecords).then(res => { console.log(res); return res })
            })
    }
    getSentences() {
